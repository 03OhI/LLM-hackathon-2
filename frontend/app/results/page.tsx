...
function ResultShell({ children }: { children: ReactNode }) { return <main className="survey-shell results-shell"><nav className="survey-nav result-nav"><Link className="survey-home" href="/" aria-label="홈으로">⌂</Link><Image className="result-duck-brand" src="/duck-face-smile.png" alt="TMTI 오리" width={74} height={74} priority /></nav>{children}</main>; }
